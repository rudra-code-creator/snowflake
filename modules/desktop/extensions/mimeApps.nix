...
with lib;
{
  options.modules.desktop.extensions.mimeApps = with types; {
    ...
    applications = {
      ...
      editor = my.mkOpt str "emacs.desktop";
      ...
      browser = my.mkOpt str "zen-beta.desktop";
    };
  };
    ...
    xdg.mime = {
      ...
      defaultApplications =
        ...
        builtins.listToAttrs (
          flatten (
            mapAttrsToList (key: types: map (type: nameValuePair type (applications."${key}")) types) mimeMap
          )
        );
    };
  };
