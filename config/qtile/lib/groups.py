...
groups.append(
    ScratchPad(
        ...
        [
            ...
            DropDown(
                "E-Mail",
                "emacs -T 'Emacs-NSP: E-Mail' --eval '(mu4e)'",
                match=Match(title="telega-scratch"),
                **next_maximum,
            ),
            DropDown(
                "Matrix",
                "emacs -T 'Emacs-NSP: Matrix' --eval '(my/connect-to-matrix)'",
                match=Match(title="ement-scratch"),
                **next_maximum,
            ),
            DropDown(
                "Telegram",
                "emacs -T 'Emacs-NSP: Telega' --eval '(telega)'",
                match=Match(title="telega-scratch"),
                **next_maximum,
            ),
...
keys.extend(
    ...
    [
        ...
        EzKey("M-A-e", lazy.group["SPD"].dropdown_toggle("E-Mail")),
